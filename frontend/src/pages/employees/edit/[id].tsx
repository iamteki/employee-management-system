...
const EditEmployee: React.FC = () => {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        form.reset({
          ...
          joiningDate: employee.joiningDate.split('T')[0], // Format the date
        });
  ...
  const onSubmit = async (data: z.infer<typeof employeeSchema>) => {
    try {
      ...
      await axios.put(`http://localhost:5000/employees/${id}`, formattedData, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <Card className="max-w-md mx-auto">
        <CardHeader>
          <CardTitle className="text-2xl font-bold">Edit Employee Details</CardTitle>
        </CardHeader>
        <CardContent>
